(function() {
    ...
    window.mostrarWidgetVivi = function(numwidget) {
        widgettop = numwidget;
        widget = true;
        $('#portal').css('top', "" + numwidget + "px").css('display', 'block');
    ...
    window.mostrarChatVivi = function(numchat, numchatright) {
        ...
        chattop = numchat
       $('#poupchat').css('top', "" + numchat + "px").css('right', "" + numchatright + "px").css('display', 'block').css('position', 'absolute');
